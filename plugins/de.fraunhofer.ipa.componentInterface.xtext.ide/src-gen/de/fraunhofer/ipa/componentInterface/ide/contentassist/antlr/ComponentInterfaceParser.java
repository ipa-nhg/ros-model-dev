		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentInterfaceAccess().getGroup_3_3(), "rule__ComponentInterface__Group_3_3__0");
					...
					put(grammarAccess.getComponentInterfaceAccess().getRospublisherAssignment_3_2(), "rule__ComponentInterface__RospublisherAssignment_3_2");
					put(grammarAccess.getComponentInterfaceAccess().getRospublisherAssignment_3_3_1(), "rule__ComponentInterface__RospublisherAssignment_3_3_1");
					put(grammarAccess.getComponentInterfaceAccess().getRossubscriberAssignment_4_2(), "rule__ComponentInterface__RossubscriberAssignment_4_2");
					put(grammarAccess.getComponentInterfaceAccess().getRossubscriberAssignment_4_3_1(), "rule__ComponentInterface__RossubscriberAssignment_4_3_1");
					put(grammarAccess.getComponentInterfaceAccess().getRosserviceserverAssignment_5_2(), "rule__ComponentInterface__RosserviceserverAssignment_5_2");
					put(grammarAccess.getComponentInterfaceAccess().getRosserviceserverAssignment_5_3_1(), "rule__ComponentInterface__RosserviceserverAssignment_5_3_1");
					put(grammarAccess.getComponentInterfaceAccess().getRosserviceclientAssignment_6_2(), "rule__ComponentInterface__RosserviceclientAssignment_6_2");
					put(grammarAccess.getComponentInterfaceAccess().getRosserviceclientAssignment_6_3_1(), "rule__ComponentInterface__RosserviceclientAssignment_6_3_1");
