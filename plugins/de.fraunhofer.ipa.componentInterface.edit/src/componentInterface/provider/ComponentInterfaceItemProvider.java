		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentInterface_name_feature", "_UI_ComponentInterface_type"),
				 ComponentInterfacePackage.Literals.COMPONENT_INTERFACE__NAME,
				 true,
				 false,
				 false,
