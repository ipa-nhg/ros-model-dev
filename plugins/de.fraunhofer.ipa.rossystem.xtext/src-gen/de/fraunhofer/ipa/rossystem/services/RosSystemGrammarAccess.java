...
public class RosSystemGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RosSystemElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cRosComponentsAssignment_4_2 = (Assignment)cGroup_4.eContents().get(2);
		private final RuleCall cRosComponentsNameSpacedComponentParserRuleCall_4_2_0 = (RuleCall)cRosComponentsAssignment_4_2.eContents().get(0);
		private final Group cGroup_4_3 = (Group)cGroup_4.eContents().get(3);
		private final Keyword cCommaKeyword_4_3_0 = (Keyword)cGroup_4_3.eContents().get(0);
		private final Assignment cRosComponentsAssignment_4_3_1 = (Assignment)cGroup_4_3.eContents().get(1);
		private final RuleCall cRosComponentsNameSpacedComponentParserRuleCall_4_3_1_0 = (RuleCall)cRosComponentsAssignment_4_3_1.eContents().get(0);
		...
		//	{RosSystem}
		//	'RosSystem'
		//	'{' ('Name' Name=EString)? ('Components' '{' RosComponents+=NameSpacedComponent (","
		//	RosComponents+=NameSpacedComponent)* '}')? ('TopicConnections' '{' TopicConnections+=TopicConnection (","
		//	TopicConnections+=TopicConnection)* '}')? ('ServiceConnections' '{' ServiceConnections+=ServiceConnection (","
		//	ServiceConnections+=ServiceConnection)* '}')?
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//{RosSystem} 'RosSystem' '{' ('Name' Name=EString)? ('Components' '{' RosComponents+=NameSpacedComponent (","
		//RosComponents+=NameSpacedComponent)* '}')? ('TopicConnections' '{' TopicConnections+=TopicConnection (","
		//TopicConnections+=TopicConnection)* '}')? ('ServiceConnections' '{' ServiceConnections+=ServiceConnection (","
		//ServiceConnections+=ServiceConnection)* '}')? '}'
		...
		//RosComponents+=NameSpacedComponent
		public Assignment getRosComponentsAssignment_4_2() { return cRosComponentsAssignment_4_2; }
		
		//NameSpacedComponent
		public RuleCall getRosComponentsNameSpacedComponentParserRuleCall_4_2_0() { return cRosComponentsNameSpacedComponentParserRuleCall_4_2_0; }
		...
		//RosComponents+=NameSpacedComponent
		public Assignment getRosComponentsAssignment_4_3_1() { return cRosComponentsAssignment_4_3_1; }
		
		//NameSpacedComponent
		public RuleCall getRosComponentsNameSpacedComponentParserRuleCall_4_3_1_0() { return cRosComponentsNameSpacedComponentParserRuleCall_4_3_1_0; }
	...
	public class NameSpacedComponentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.fraunhofer.ipa.rossystem.RosSystem.NameSpacedComponent");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRosComponentKeyword_0 = (Keyword)cGroup.eContents().get(0);
		...
		private final RuleCall cNameSpaceEStringParserRuleCall_1_1_0 = (RuleCall)cNameSpaceAssignment_1_1.eContents().get(0);
		private final Assignment cRosComponentAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final CrossReference cRosComponentComponentInterfaceCrossReference_2_0 = (CrossReference)cRosComponentAssignment_2.eContents().get(0);
		private final RuleCall cRosComponentComponentInterfaceEStringParserRuleCall_2_0_1 = (RuleCall)cRosComponentComponentInterfaceCrossReference_2_0.eContents().get(1);
		
		//NameSpacedComponent:
		//	'RosComponent' ('NameSpace' NameSpace=EString)?
		//	RosComponent=[componentInterface::ComponentInterface|EString];
		@Override public ParserRule getRule() { return rule; }
		
		//'RosComponent' ('NameSpace' NameSpace=EString)? RosComponent=[componentInterface::ComponentInterface|EString]
		public Group getGroup() { return cGroup; }
		
		//'RosComponent'
		public Keyword getRosComponentKeyword_0() { return cRosComponentKeyword_0; }
		...
		//EString
		public RuleCall getNameSpaceEStringParserRuleCall_1_1_0() { return cNameSpaceEStringParserRuleCall_1_1_0; }
		
		//RosComponent=[componentInterface::ComponentInterface|EString]
		public Assignment getRosComponentAssignment_2() { return cRosComponentAssignment_2; }
		
		//[componentInterface::ComponentInterface|EString]
		public CrossReference getRosComponentComponentInterfaceCrossReference_2_0() { return cRosComponentComponentInterfaceCrossReference_2_0; }
		
		//EString
		public RuleCall getRosComponentComponentInterfaceEStringParserRuleCall_2_0_1() { return cRosComponentComponentInterfaceEStringParserRuleCall_2_0_1; }
	}
	...
	private final NameSpacedComponentElements pNameSpacedComponent;
	...
	public RosSystemGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pNameSpacedComponent = new NameSpacedComponentElements();
	...
	//	'RosComponent' ('NameSpace' NameSpace=EString)?
	//	RosComponent=[componentInterface::ComponentInterface|EString];
	public NameSpacedComponentElements getNameSpacedComponentAccess() {
		return pNameSpacedComponent;
	}
	
	public ParserRule getNameSpacedComponentRule() {
		return getNameSpacedComponentAccess().getRule();
	}
